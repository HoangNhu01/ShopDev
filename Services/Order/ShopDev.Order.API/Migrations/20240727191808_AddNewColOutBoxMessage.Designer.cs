...
namespace ShopDev.Order.API.Migrations
{
    ...
    [Migration("20240727191808_AddNewColOutBoxMessage")]
    partial class AddNewColOutBoxMessage
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ShopDev.Order.Domain.Order.OrderGen", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValue(new Guid("ca6a15be-51f3-4b89-8fa7-7493b19147d1"));
                            ...
                            b1.OwnsMany("ShopDev.Order.Domain.Products.Spu", "Spus", b2 =>
                                {
                                    ...
                                    b2.HasKey("ProductOrderDetailId", "Id");
