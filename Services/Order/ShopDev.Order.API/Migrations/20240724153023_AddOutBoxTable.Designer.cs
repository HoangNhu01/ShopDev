...
namespace ShopDev.Order.API.Migrations
{
    ...
    [Migration("20240724153023_AddOutBoxTable")]
            ...
            modelBuilder.Entity("ShopDev.Order.Domain.Order.OrderDetail", b =>
                {
                    ...
                    b.HasIndex(new[] { "ProductId", "SpuId", "Deleted" }, "IX_OrderDetail")
                        .IsDescending();
            ...
            modelBuilder.Entity("ShopDev.Order.Domain.Order.OrderGen", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValue(new Guid("452ff95e-77d6-4f00-8ecd-bec7820c7385"));
